 ...
 */
-(void)initSayingsOfCateAllWithComplete:(void (^)(NSArray *))complete{
 ...
 */
-(void)initSayingOfCate:(NSString *)cate reloadFromServer:(BOOL)needReload complete:(void (^)(SayingCateModel *))_complete{
 ...
 */
-(void)requestSayingOfCate:(NSString *)cate pageIndex:(NSInteger)pIndex complete:(void (^)(SayingCateModel *))_complete{
